...
public class   loginsteps {
    ...
    public void i_am_on_the_login_page() throws IOException {
        ...
        trackingCif = new Checker_Tracking_CIF
                (driver);
    ...
    public void iFillInTheLoginInformationAnd(String username, String password) {
    ...
    public void i_navigate_to_customer_information() throws InterruptedException {
    ...
    public void i_fill_in_the_customer_information() {
    ...
    public void iFillInThePEPCustomerDemographic() {
        Map<String, String> data = currentRowData;
    ...
    public void iFillInTheContactDetail() {
        Map<String, String> data = currentRowData;
    ...
    public void iFillInTheNextOfKinDetail() {
        Map<String, String> data = currentRowData;
    ...
    public void iFillInTheAccountDetail() {
        Map<String, String> data = currentRowData;
    ...
    @And("Uploading Files:")
    public void uploadingFiles() throws IOException {
    ...
    private void perform() throws InterruptedException, IOException {
        currentRowData = HttpGet.getNextRow();
        ...
        iFillInTheLoginInformationAnd("shahroze.janjua", "Nuzhat.123");
        i_log_in();
    ...
    @And("Close it")
    public void closeIt() throws IOException, InterruptedException {
