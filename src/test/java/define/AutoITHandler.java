...
public class AutoITHandler {
    ...
    public static void launchChromeInGuestMode() throws IOException {
        // Path to the AutoIT script to launch Chrome in Guest Mode
        String autoItScriptPathForGuestMode = "C:\\Users\\Shahroze.Janjua\\Desktop\\launch_guest_mode1.exe";  // Path to the AutoIT script for launching Chrome in Guest Mode

        // Execute the AutoIT script to launch Chrome in Guest Mode
        Runtime.getRuntime().exec(autoItScriptPathForGuestMode);
    }
}
